	...
	while True:
		...
		############################################
			...
			if reg_ex:
				...
				subprocess.Popen(["open", "-n", "/Applications/" + appname1], stdout=subprocess.PIPE).speak('I have launched the desired application')
			...
			speak("I have been created by Wastu.")
			...
			speak("Thanks to Wastu. further It's a secret")
			...
			speak("I am your virtual assistant created by Wastu")

		elif 'reason for you' in query:
			speak("I was created as a Minor project by Mister Wastu ")
